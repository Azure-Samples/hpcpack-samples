...
namespace HelloWorldR2MultiBatch.EchoService {
    ...
    public interface IService1 {
        ...
        HelloWorldR2MultiBatch.EchoService.EchoResponse Echo(HelloWorldR2MultiBatch.EchoService.EchoRequest request);
        ...
        HelloWorldR2MultiBatch.EchoService.EchoOnExitResponse EchoOnExit(HelloWorldR2MultiBatch.EchoService.EchoOnExitRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Channel : HelloWorldR2MultiBatch.EchoService.IService1, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1Client : System.ServiceModel.ClientBase<HelloWorldR2MultiBatch.EchoService.IService1>, HelloWorldR2MultiBatch.EchoService.IService1 {
        ...
        public HelloWorldR2MultiBatch.EchoService.EchoResponse Echo(HelloWorldR2MultiBatch.EchoService.EchoRequest request) {
            return base.Channel.Echo(request);
        }
        
        public HelloWorldR2MultiBatch.EchoService.EchoOnExitResponse EchoOnExit(HelloWorldR2MultiBatch.EchoService.EchoOnExitRequest request) {
